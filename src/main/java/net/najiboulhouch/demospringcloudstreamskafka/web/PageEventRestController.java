package net.najiboulhouch.demospringcloudstreamskafka.web;

import net.najiboulhouch.demospringcloudstreamskafka.entities.PageEvent;
...
public class PageEventRestController {
    ...
    public PageEvent sendMessage(@PathVariable String topic , @PathVariable String name){
